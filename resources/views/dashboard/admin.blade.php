...
@section('page_style')
    <link href="{{URL('/')}}/assets/layouts/layout/css/layout_met.css" rel="stylesheet" type="text/css" />
@endsection
@section('content')
<!-- BEGIN SIDEBAR -->
...
@endsection
@section('page_js')
<script src="{{URL('/')}}/assets/layouts/layout/scripts/layout_met.min.js" type="text/javascript"></script>
@endsection
