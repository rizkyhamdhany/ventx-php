...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <h1 class="page-title"> Edit Ticket Period for {{$page_title}}
        </h1>
        <div class="row">
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                      <!-- BEGIN FORM-->
                        <form method="POST" action="{{route('dashboard.event.ticketPeriod.edit',[$id,$period])}}" class="form-horizontal">
                            {{ csrf_field() }}
                            <div class="form-body">
                                <div class="form-group {{$errors->has('name') ? 'has-error' : ' ' }}">
                                    <label class="col-md-3 control-label">Period Name</label>
                                    <div class="col-md-4">
                                        <input type="text" name="name" class="form-control" placeholder="Ex : Presale/Reguler" value="{{ $period->name }}">
                                ...
                                <div class="form-group {{$errors->has('organizer') ? 'has-error' : ' ' }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control form-control-inline date-picker" size="16" type="text" value="{{date('m/d/Y', strtotime($period->start_date))}}" name="startDate" />
                                        </div>
                                ...
                                <div class="form-group {{$errors->has('date') ? 'has-error' : ' ' }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input class="form-control form-control-inline date-picker" size="16" type="text" value="{{date('m/d/Y', strtotime($period->end_date))}}" name="endDate" />
                                        </div>
                                        <span class="help-block"> Select Date </span>
                                    </div>
                                </div>
