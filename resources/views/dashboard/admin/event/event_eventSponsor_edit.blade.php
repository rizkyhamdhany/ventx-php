...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <h1 class="page-title"> Edit Sponsor for {{$page_title}}
        </h1>
        <div class="row">
            <div class="col-md-12">
                <div class="portlet light bordered">
                    <div class="portlet-body form">
                      <!-- BEGIN FORM-->
                        <form method="POST" action="{{route('dashboard.event.eventSponsor.edit.post',[$id,$sponsor])}}" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-body">
                                <div class="form-group {{$errors->has('name') ? 'has-error' : ' ' }}">
                                    <label class="col-md-3 control-label">Sponsor Name</label>
                                    <div class="col-md-4">
                                        <input type="text" name="name" class="form-control" placeholder="Ex : Rizky Hamdhany" value="{{ $sponsorRepo->name }}">
                                ...
                                <div class="form-group {{$errors->has('organizer') ? 'has-error' : ' ' }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            <input type="file" name="photo"/ value="<?php echo asset('storage/'.$sponsorRepo->url_img); ?>">
                                        </div>
