                ...
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form method="POST" action="{{route('dashboard.event.edit.post',$event->id)}}" class="form-horizontal" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <div class="form-group {{$errors->has('name') ? 'has-error' : ' ' }}">
                                        <label class="col-md-3 control-label">Event Name</label>
                                        <div class="col-md-4">
                                            <input type="text" name="name" class="form-control" placeholder="Ex : Guns and Roses Concert" value="{{ $event->name }}">
                                    ...
                                    <div class="form-group {{$errors->has('short_name') ? 'has-error' : ' ' }}">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="short_name" class="form-control" placeholder="Ex : Guns and Roses" value="{{ $event->short_name }}">
                                    ...
                                    <div class="form-group {{$errors->has('logo_color') ? 'has-error' : ' ' }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <span><small><small><i>* Leave empty if you don't want to change</i></small></small></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group {{$errors->has('color_primary') ? 'has-error' : ' ' }}">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="color_primary" class="form-control" value="{{ $event->color_primary }}">
                                    ...
                                    <div class="form-group {{$errors->has('color_secondary') ? 'has-error' : ' ' }}">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="color_secondary" class="form-control" value="{{ $event->color_secondary }}">
                                    ...
                                    <div class="form-group {{$errors->has('color_accent') ? 'has-error' : ' ' }}">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="color_accent" class="form-control" value="{{ $event->color_accent }}">
                                    ...
                                    <div class="form-group {{$errors->has('location') ? 'has-error' : ' ' }}">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="location" id="summernote_1">{{ $event->location }}</textarea>
                                    ...
                                    <div class="form-group {{$errors->has('lon') ? 'has-error' : ' ' }}">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="lon" value="{{ $event->lon }}">
