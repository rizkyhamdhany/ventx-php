<form class="horizontal-form"  action="{{route('app.event.ticket.book.post', [$event->short_name])}}" method="POST" onsubmit="document.getElementById('ticket_ammount').disabled = false;">
    {{ csrf_field() }}
    ...
    <div class="table-scrollable">
        <table class="table table-ticket table-striped table-hover">
            ...
            <tr>
                ...
                <td id="ticket-price"> IDR {{number_format( $event->price_reguler , 0 , '' , '.' )}} </td>
                <td>
